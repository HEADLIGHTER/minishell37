...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/30 20:23:31 by krnearin          #+#    #+#             */
/*   Updated: 2022/03/31 21:16:11 by krnearin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "minishell.h"
...
void	foo(t_env *env, int last_exit, int i, t_list *tkn)
{
	char	*str;
